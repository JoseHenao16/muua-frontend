      ...
      <div class="row q-col-gutter-lg">
        ...
        <div class="col-12 col-md-5">
          <q-card flat bordered>
            <q-img :src="imagenUrl" :ratio="1" spinner-color="primary">
        ...
        <div class="col-12 col-md-7">
          ...
          <div class="text-subtitle2 text-grey-6 q-mb-md">
            {{ pieza.coleccion }} · {{ pieza.grupoColeccion }}
          </div>
          ...
          <div class="row q-col-gutter-sm q-mb-md">
            ...
            <div class="col-6">
              <CampoDetalle label="Categoría conservación" :valor="pieza.categoria" />
            </div>
            <div class="col-12">
              <CampoDetalle label="Observaciones" :valor="pieza.observaciones" />
            </div>
          </div>
          ...
          <div class="row q-col-gutter-sm q-mb-md">
            <div class="col-6">
              <CampoDetalle label="Zona arqueológica" :valor="pieza.zonaArqueologica" />
            </div>
            ...
            <div class="col-6">
              <CampoDetalle label="Departamento" :valor="pieza.departamento" />
            </div>
          ...
          <div class="row q-col-gutter-sm q-mb-md">
            ...
            <div class="col-6">
              <CampoDetalle label="Técnica elaboración" :valor="pieza.tecnicaElaboracion" />
            </div>
            <div class="col-6">
              <CampoDetalle label="Técnica decoración" :valor="pieza.tecnicaDecoracion" />
            </div>
            <div class="col-6">
              <CampoDetalle label="Técnica acabado" :valor="pieza.tecnicaAcabado" />
            </div>
          </div>

          <!-- Sección: Medidas -->
          <div class="text-subtitle2 text-weight-bold q-mb-sm">
            Medidas ({{ pieza.unidadMedida }})
          </div>
          <div class="row q-col-gutter-sm q-mb-md">
          ...
          <div class="row q-gutter-sm q-mt-sm">
            ...
            <q-btn
              ...
              icon="picture_as_pdf"
              label="Reporte PDF"
              @click="generarReportePdfIndividual"
            />
          </div>
        </div>
      </div>
